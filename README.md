...
#          K-Nearest Neighbors (KNN) is a simple, yet powerful, supervised machine learning algorithm commonly used for classification and regression tasks. It makes predictions based on the similarity of input 
#          data points to other data points in the training set.
import pickle 
